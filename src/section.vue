    ...
    <div class="navbar-top">
      <div class="container">
        ...
        <div class="content-nav" :class="{ shadow: scrollStarted }">
          ...
          <wwLayoutColumn
            class="left-row"
            :class="{ show: scrollStarted }"
            tag="div"
            ww-default="ww-row"
            :ww-list="section.data.leftRow"
            @ww-add="add(section.data.leftRow, $event)"
            @ww-remove="remove(section.data.leftRow, $event)"
          >
          ...
          <wwLayoutColumn
            ...
            tag="div"
            ww-default="ww-row"
            :ww-list="section.data.rightRow"
            @ww-add="add(section.data.rightRow, $event)"
            @ww-remove="remove(section.data.rightRow, $event)"
          >
    ...
    toggleNavbar() {
      ...
      if (this.navbarOpen) {
        ...
        for (let container of this.$el.querySelectorAll(".container")) {
          container.classList.add("navbar-weweb-landing-open");
        }
      } else {
        for (let section of document.querySelectorAll(".ww-section:not([ww-fixed])")) {
        ...
        for (let container of this.$el.querySelectorAll(".container")) {
          container.classList.remove("navbar-weweb-landing-open");
        }
      }
    },
